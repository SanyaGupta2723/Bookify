...
function Hero() {
  ...
  return (
    <section className="bg-base-100 pt-5 pb-14 md:pt-32 md:pb-24">
      <div className="max-w-7xl mx-auto px-5 flex flex-col md:flex-row items-center gap-6 md:gap-14">
  ...
  >
    Browse Books
        ...
        <div className="w-full md:w-1/2 flex justify-center mt-4 md:mt-0">
          <div className="relative w-full h-[170px] sm:h-[220px] md:h-[320px] lg:h-[360px]
                          max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-xl
                          rounded-xl overflow-hidden shadow-lg border border-white/10">
